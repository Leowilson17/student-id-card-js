var profileData = [
    {
        ...
        gitlink : 'https://www.jobscan.co/wp-content/uploads/resume-upload-to-linkedin.png',
        resumelink : 'https://github.com/selva06092020',
        primaryLang1 :'HTML,',
        primaryLang2 : 'CSS,',
...

    {
        ...
        gitlink : 'https://www.jobscan.co/wp-content/uploads/resume-upload-to-linkedin.png',
        resumelink : 'https://github.com/Leowilson17?tab=repositories',
        primaryLang1 :'HTML,',
        primaryLang2 : 'CSS,',
        primaryLang3 : 'JavaScript',
        salary : '3.5 L',
...
flexDiv.setAttribute('class','first-div');
document.body.appendChild(flexDiv);
var x = function idCard(data){
...
//  create secondary head
    ...
    var instutionDetails = [data.college,data.hsc,data.sslc];
